...
LOCATION = os.getenv("GOOGLE_RAG_ENGINE_LOCATION")
if not LOCATION:
    raise ValueError(
        "GOOGLE_RAG_ENGINE_LOCATION environment variable not set. Please set it in your .env file."
    )
CORPUS_DISPLAY_NAME = "Alphabet_10K_2024_corpus"
CORPUS_DESCRIPTION = "Corpus containing Alphabet's 10-K 2024 document"
PDF_URL = "https://www.cuisinedaubery.com/pubaccess/pierrehermesvanillacremebrule.pdf"
